...
//    }
    ...
    if (config && config.load && config.load.animation_speed) {
      let speed = config.load.animation_speed - ((config.load.animation_speed-1) * (parseInt(stateObj14.state) / config.load.max_power || parseInt(stateObj14.state)))
    ...
    if (config && config.load && config.grid.animation_speed) {
      let speed = config.load.animation_speed - ((config.grid.animation_speed-1) * (parseInt(stateObj34.state) / config.grid.max_power || parseInt(stateObj34.state)))
      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 -0.5 457 383" height="${panel === 'no' ? '396px' : '100%'}" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <text id="daily_load" x="83%" y="18.5%" class="st3 left-align" fill="${load_showdaily === 'no' || show_aux === 'yes' ? 'transparent' : `${load_colour}`}" >DAILY LOAD</text>
            ...
            <text x="90%" y="21.5%" class="st3 st8" display="${show_aux === 'no' ? 'none' : ''}" fill="${load_colour}">Auxiliary</text> 
            ...
            <svg xmlns="http://www.w3.org/2000/svg" id="prog_grid" x="55%" y="87%" width="24" height="24" viewBox="0 0 24 24""><path fill="${battery_colour}" class="${inverter_prog.charge === 'grid' || inverter_prog.charge === 'both' ? '' : 'st12'}" fill="${grid_colour} d="m8.28 5.45l-1.78-.9L7.76 2h8.47l1.27 2.55l-1.78.89L15 4H9l-.72 1.45M18.62 8h-4.53l-.79-3h-2.6l-.79 3H5.38L4.1 10.55l1.79.89l.73-1.44h10.76l.72 1.45l1.79-.89L18.62 8m-.85 14H15.7l-.24-.9L12 15.9l-3.47 5.2l-.23.9H6.23l2.89-11h2.07l-.36 1.35L12 14.1l1.16-1.75l-.35-1.35h2.07l2.89 11m-6.37-7l-.9-1.35l-1.18 4.48L11.4 15m3.28 3.12l-1.18-4.48l-.9 1.36l2.08 3.12Z"/></svg>

            <svg xmlns="http://www.w3.org/2000/svg" id="prog_gen" x="58%" y="87%" width="24" height="24" viewBox="0 0 24 24">
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M349.867,290.133H162.133c-4.71,0-8.533,3.823-8.533,8.533s3.823,8.533,8.533,8.533h187.733 c4.71,0,8.533-3.823,8.533-8.533S354.577,290.133,349.867,290.133z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M349.867,256H162.133c-4.71,0-8.533,3.823-8.533,8.533s3.823,8.533,8.533,8.533h187.733c4.71,0,8.533-3.823,8.533-8.533 S354.577,256,349.867,256z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M409.6,85.333H384c-4.71,0-8.533,3.823-8.533,8.533v273.067c0,4.71,3.823,8.533,8.533,8.533s8.533-3.823,8.533-8.533 V102.4H409.6c47.053,0,85.333,38.281,85.333,85.333V307.2c0,47.053-38.281,85.333-85.333,85.333H162.133 c-4.71,0-8.533,3.823-8.533,8.533s3.823,8.533,8.533,8.533H409.6c56.465,0,102.4-45.935,102.4-102.4V187.733 C512,131.268,466.065,85.333,409.6,85.333z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M179.2,68.267c4.71,0,8.533-3.823,8.533-8.533c0-14.114,11.486-25.6,25.6-25.6H281.6c14.114,0,25.6,11.486,25.6,25.6 c0,4.71,3.823,8.533,8.533,8.533s8.533-3.823,8.533-8.533c0-23.526-19.14-42.667-42.667-42.667h-68.267 c-23.526,0-42.667,19.14-42.667,42.667C170.667,64.444,174.49,68.267,179.2,68.267z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M349.867,324.267H162.133c-4.71,0-8.533,3.823-8.533,8.533s3.823,8.533,8.533,8.533h187.733 c4.71,0,8.533-3.823,8.533-8.533S354.577,324.267,349.867,324.267z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M349.867,221.867H162.133c-4.71,0-8.533,3.823-8.533,8.533c0,4.71,3.823,8.533,8.533,8.533h187.733 c4.71,0,8.533-3.823,8.533-8.533C358.4,225.69,354.577,221.867,349.867,221.867z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M128,119.467c-4.71,0-8.533,3.823-8.533,8.533v264.533H102.4c-47.053,0-85.333-38.281-85.333-85.333V187.733 c0-47.053,38.281-85.333,85.333-85.333h247.467c4.71,0,8.533-3.823,8.533-8.533s-3.823-8.533-8.533-8.533H102.4 C45.935,85.333,0,131.268,0,187.733V307.2c0,56.465,45.935,102.4,102.4,102.4H128c4.71,0,8.533-3.823,8.533-8.533V128 C136.533,123.29,132.71,119.467,128,119.467z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M349.867,358.4H162.133c-4.71,0-8.533,3.823-8.533,8.533s3.823,8.533,8.533,8.533h187.733 c4.71,0,8.533-3.823,8.533-8.533S354.577,358.4,349.867,358.4z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M205.056,435.2c0-4.71-3.814-8.533-8.533-8.533h-0.085c-4.71,0-8.491,3.823-8.491,8.533s3.866,8.533,8.576,8.533 C201.242,443.733,205.056,439.91,205.056,435.2z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M349.867,426.667c-4.71,0-8.533,3.823-8.533,8.533v17.067c0,14.114-11.486,25.6-25.6,25.6H196.267 c-14.114,0-25.6-11.486-25.6-25.6V435.2c0-4.71-3.823-8.533-8.533-8.533c-4.71,0-8.533,3.823-8.533,8.533v17.067 c0,23.526,19.14,42.667,42.667,42.667h119.467c23.526,0,42.667-19.14,42.667-42.667V435.2 C358.4,430.49,354.577,426.667,349.867,426.667z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M349.867,187.733H162.133c-4.71,0-8.533,3.823-8.533,8.533s3.823,8.533,8.533,8.533h187.733 c4.71,0,8.533-3.823,8.533-8.533S354.577,187.733,349.867,187.733z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M324.523,435.2c0-4.71-3.814-8.533-8.533-8.533h-0.085c-4.71,0-8.491,3.823-8.491,8.533s3.866,8.533,8.576,8.533 C320.708,443.733,324.523,439.91,324.523,435.2z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M349.867,119.467H162.133c-4.71,0-8.533,3.823-8.533,8.533s3.823,8.533,8.533,8.533h187.733 c4.71,0,8.533-3.823,8.533-8.533S354.577,119.467,349.867,119.467z"/>
              <path fill="${battery_colour}" class="${inverter_prog.charge === 'gen' || inverter_prog.charge === 'both' ? '' : 'st12'}" d="M349.867,153.6H162.133c-4.71,0-8.533,3.823-8.533,8.533c0,4.71,3.823,8.533,8.533,8.533h187.733 c4.71,0,8.533-3.823,8.533-8.533C358.4,157.423,354.577,153.6,349.867,153.6z"/>
            </svg>
            ...
            : svg`<text id="pv1_power_186" x="8%" y="14.75%" class="${font === 'no' ? 'st14' : 'st4'} st8" display="${config.show_solar === 'no'  ? 'none' : ''}" fill="${solar_colour}" >${stateObj9.state ? stateObj9.state : '0'} W</text>`}
            ...
            : svg`<text id="pv2_power_187" x="30%" y="14.75%" class="${font === 'no' ? 'st14' : 'st4'} st8" display="${config.show_solar === 'no' || config.solar.mppts === 'one' ? 'none' : ''}" fill="${solar_colour}">${stateObj8.state ? stateObj8.state : '0'} W</text>`}
            ...
            : svg`<text id="pv3_power_188" x="8%" y="30.5%" class="${font === 'no' ? 'st14' : 'st4'} st8" display="${config.show_solar === 'no' || config.solar.mppts === 'one' || config.solar.mppts === 'two'? 'none' : ''}" fill="${solar_colour}">${stateObj31.state ? stateObj31.state : '0'} W</text>`}
            ...
            : svg`<text id="pv4_power_189" x="30%" y="30.5%" class="${font === 'no' ? 'st14' : 'st4'} st8" display="${config.show_solar === 'no' || config.solar.mppts === 'one' || config.solar.mppts === 'two' || config.solar.mppts === 'three' ? 'none' : ''}" fill="${solar_colour}">${stateObj32.state ? stateObj32.state : '0'} W</text>`}
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_grid_voltage_154)}>
              <text id="inverter_grid_voltage_154" x="59%" y="44.5%" class="${font === 'no' ? 'st14' : 'st4'} st8" fill="${grid_colour}" >${stateObj5.state ? stateObj5.state : '0'} V</text>
            </a>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_out_164)}>
              <text id="inverter_out_164" x="39.5%" y="52%" class="${font === 'no' ? 'st14' : 'st4'} st8" fill="${inverter_colour}">${stateObj7.state ? stateObj7.state : '0'} A</text>
            </a>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.battery_soc_184)}>
              <text id="battery_soc_184" x="35%" y="87%" fill=${battery_colour} class="st13 st8 left-align" display="${inverter_prog.show != 'no' ? 'none' : ''}">${stateObj12.state ? stateObj12.state : '0'}%</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.battery_soc_184)}>
              <text id="battery_soc_184" x="35%" y="87%" fill=${battery_colour} class="st13 st8 left-align" display="${inverter_prog.show === 'no' ? 'none' : ''}">${stateObj12.state ? stateObj12.state : '0'}% | ${inverter_prog.capacity ? inverter_prog.capacity : '0'}%</text>
            </a>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.battery_current_191)}>
              <text id="battery_current_191" x="9%" y="87.75%" fill=${battery_colour} class="${font === 'no' ? 'st14' : 'st4'} st8">${stateObj35.state ? stateObj35.state : '0'} A</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_out_175)}>
              <text id="inverter_out_175" x="39.5%" y="46.5%" class="${font === 'no' ? 'st14' : 'st4'} st8" fill="${inverter_colour}">${stateObj22.state ? stateObj22.state : '0'} W</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_load_grid_169)}>
              <text id="inverter_load_grid_169" x="59%" y="54.5%" class="${font === 'no' ? 'st14' : 'st4'} st8" fill="${grid_colour}">${stateObj23.state ? stateObj23.state : '0'} W</text>
            </a>
      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 ${config.show_solar === 'no' ? 145.33 : -0.5} 483 ${config.show_solar === 'no' ? 270.67 : 406}" height="${panel === 'no' ? `${config.show_solar === 'no' ? '246px' : '396px'}` : `${config.show_solar === 'no' ? '75%' : '100%'}`}" width="100%"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.battery_out_190)}>
              <text id="battery_out_190" x="193" y="386" fill=${battery_colour} class="${font === 'no' ? 'st14' : 'st4'} st8">${battery_power < '0' ? battery_power *-1 : battery_power} W</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.battery_current_191)}>
            ...
            : svg`<text id="pv1_power_186" x="188.1" y="71" class="${font === 'no' ? 'st14' : 'st4'} st8" display="${config.show_solar === 'no' ? 'none' : ''}" fill="${solar_colour}">${stateObj9.state ? stateObj9.state : '0'} W</text>`}
            ${config.entities.pv2_power_187 !== 'none'
            ? svg`<a href="#" @click=${(e) => this.handlePopup(e, config.entities.pv2_power_187)}>
            ...
            : svg`<text id="pv2_power_187" x="289.5" y="71" class="${font === 'no' ? 'st14' : 'st4'} st8" display="${config.show_solar === 'no' || config.solar.mppts === 'one' ? 'none' : ''}" fill="${solar_colour}">${stateObj8.state ? stateObj8.state : '0'} W</text>`}
            ${config.entities.pv3_power_188 !== 'none'
            ? svg`<a href="#" @click=${(e) => this.handlePopup(e, config.entities.pv3_power_188)}>
            ...
            : svg`<text id="pv3_power_188" x="113" y="71" class="${font === 'no' ? 'st14' : 'st4'} st8" display="${config.show_solar === 'no' || config.solar.mppts === 'one' || config.solar.mppts === 'two' ? 'none' : ''}" fill="${solar_colour}">${stateObj31.state ? stateObj31.state : '0'} W</text>`}
            ${config.entities.pv4_power_189 !== 'none'
            ? svg`<a href="#" @click=${(e) => this.handlePopup(e, config.entities.pv4_power_189)}>
            ...
            : svg`<text id="pv4_power_189" x="366" y="71" class="${font === 'no' ? 'st14' : 'st4'} st8" display="${config.show_solar === 'no' || config.solar.mppts === 'one' || config.solar.mppts === 'two' || config.solar.mppts === 'three' ? 'none' : ''}" fill="${solar_colour}">${stateObj32.state ? stateObj32.state : '0'} W</text>`}
            ${config.entities.essential_power !== 'none'
            ? svg`<a href="#" @click=${(e) => this.handlePopup(e, config.entities.essential_power)}>
