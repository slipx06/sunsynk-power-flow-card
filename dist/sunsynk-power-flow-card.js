      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 -0.5 483 406" height="396px" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            <text id="daily_bat_charge_value" x="16%" y="85%" class="${config.show_daily === 'no' ? 'st11' : 'st10 st2 left-align'}" >${stateObj1.state ? stateObj1.state : '0'} kWh</text>
            <text id="daily_bat_charge" x="16%" y="88%" class="${config.show_daily === 'no' ? 'st11' : 'st3 st2 left-align'}" >DAILY CHARGE</text>
            ...
            <text id="daily_bat_discharge_value" x="16%" y="93.75%" class="${config.show_daily === 'no' ? 'st11' : 'st10 st2 left-align'}" >${stateObj.state ? stateObj.state : '0'} kWh</text>
            <text id="daily_bat_charge" x="16%" y="97%" class="${config.show_daily === 'no' ? 'st11' : 'st3 st2 left-align'}" >DAILY DISCHARGE</text>
            <text id="daily_load_value" x="83%" y="66%" class="${config.show_daily === 'no' ? 'st11' : 'st10 st6 left-align'}" >${stateObj2.state ? stateObj2.state : '0'} kWh</text>
            <text id="daily_load" x="83%" y="69.5%" class="${config.show_daily === 'no' ? 'st11' : 'st3 st6 left-align'}" >DAILY LOAD</text>
            <text id="daily_grid_value" x="3%" y="66%" class="${config.show_daily === 'no' ? 'st11' : 'st10 st7 left-align'}" >${stateObj3.state ? stateObj3.state : '0'} kWh</text>
            <text id="daily_grid" x="3%" y="69.5%" class="${config.show_daily === 'no' ? 'st11' : 'st3 st7 left-align'}" >DAILY GRID</text>
            <text id="daily_solar_value" x="47%" y="4%" class="${config.show_daily === 'no' || config.show_solar === 'no' ? 'st11' : 'st10 st1 left-align'}" >${stateObj4.state ? stateObj4.state : '0'} kWh</text>
            <text id="daily_solar" x="47%" y="7.5%" class="${config.show_daily === 'no' || config.show_solar === 'no' ? 'st11' : 'st3 st1 left-align'}" >DAILY SOLAR</text>
            ...
            <text id="pv2_power_187" x="60%" y="17.5%" class="${config.show_solar === 'no' ? 'st12' : 'st1 st4 st8'}">${stateObj8.state ? stateObj8.state : '0'} W</text>
            <text id="pv1_power_186" x="39%" y="17.5%" class="${config.show_solar === 'no' ? 'st12' : 'st1 st4 st8'}">${stateObj9.state ? stateObj9.state : '0'} W</text>
            <text id="pvtotal_power" x="49.5%" y="33%" class="${config.show_solar === 'no' ? 'st12' : 'st1 st4 st8'}">${totalsolar ? totalsolar : '0'} W</text>
            <text x="36%" y="23%" class="${config.show_solar === 'no' ? 'st12' : 'st1 st3 st8'}">PV1</text>
            <text x="56.5%" y="23%" class="${config.show_solar === 'no' ? 'st12' : 'st1 st3 st8'}">PV2</text>
            ...
            <text id="pv1_v" x="25%" y="16%" class="${config.show_solar === 'no' ? 'st12' : 'st3 st1 left-align'}" >${stateObj16.state ? stateObj16.state : '0'} V</text>
            <text id="pv1_i" x="25%" y="19%" class="${config.show_solar === 'no' ? 'st12' : 'st3 st1 left-align'}" >${stateObj17.state ? stateObj17.state : '0'} A</text>
            <text id="pv2_v" x="68.75%" y="16%" class="${config.show_solar === 'no' ? 'st12' : 'st3 st1 left-align'}" >${stateObj18.state ? stateObj18.state : '0'} V</text>
            <text id="pv2_i" x="68.75%" y="19%" class="${config.show_solar === 'no' ? 'st12' : 'st3 st1 left-align'}" >${stateObj19.state ? stateObj19.state : '0'} A</text>
            ...
            <text id="timer_text_off" x="59.5%" y="62.75%" class="${stateObj26.state == 'off' && config.entities.use_timer_248 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Timer off</text>
            <text id="timer_text_on" x="59.5%" y="62.75%" class="${stateObj26.state == 'on' && config.entities.use_timer_248 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Timer on</text>
            ...
            <text id="priority_text_batt"x="59.5%" y="67.25%" class="${stateObj25.state === 'off' && config.entities.priority_load_243 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Priority Batt</text>
            <text id="priority_text_load"x="59.5%" y="67.25%" class="${stateObj25.state === 'on' && config.entities.priority_load_243 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Priority Load</text>
