      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 -0.5 457 383" height="${panel === 'no' ? '396px' : '100%'}" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" id="prog_grid" x="61.5%" y="82.5%" width="30" height="28" viewBox="0 0 24 24"><path class="${inverter_prog.charge === 'none' ? 'st12' : ''}" fill="${battery_colour}" d="m7 20v-6h-3l5-9v6h3l-5 9Z"/></svg>
