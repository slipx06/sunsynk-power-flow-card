      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 -0.5 457 383" height="${config.panel_mode === 'no' ? '396px' : '100%'}" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <text id="pv1_power_186" x="8%" y="14.75%" class="st4 st8" display="${config.solar.show_solar === 'no'  ? 'none' : ''}" fill="${config.solar.colour}" @click=${(e) => this.handlePopup(e, config.entities.pv1_power_186)}>${stateObj9.state ? stateObj9.state : '0'} W</text>
