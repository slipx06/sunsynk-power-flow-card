    ...
    if (config.cardstyle === 'full') {
      return html`
        <div class="container card">
          ...
          <text id="timer_text"x="50%" y="68.5%" class="${config.use_timer_268 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Timer</text>
          ...
          <text id="timer_text"x="50%" y="73.5%" class="${config.priority_load_243 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Priority</text>
          </svg>
        </div>
      `;
    }
      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 -0.5 456 380" height="396px" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <text id="timer_text"x="55%" y="67.5%" class="${config.use_timer_268 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Timer</text>
            ...
            <text id="timer_text"x="55%" y="72.5%" class="${config.priority_load_243 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Priority</text>
      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 -0.5 483 406" height="396px" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <text id="timer_text"x="59%" y="63.5%" class="${config.priority_load_243 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Priority</text>
