...
class SunsynkPowerFlowCard extends LitElement {
  ...
  render() {
    ...
    const stateObj = this.hass.states[config.entities.batdischargeday_71] ? this.hass.states[config.entities.batdischargeday_71] : { state: '0' };
    const stateObj1 = this.hass.states[config.entities.batchargeday_70] ? this.hass.states[config.entities.batchargeday_70] : { state: '0' };
    const stateObj2 = this.hass.states[config.entities.loadday_84] ? this.hass.states[config.entities.loadday_84] : { state: '0' };
    const stateObj3 = this.hass.states[config.entities.gridday_76] ? this.hass.states[config.entities.gridday_76] : { state: '0' };
    const stateObj4 = this.hass.states[config.entities.solarday_108] ? this.hass.states[config.entities.solarday_108] : { state: '0' };
    const stateObj5 = this.hass.states[config.entities.inverter_grid_voltage_154] ? this.hass.states[config.entities.inverter_grid_voltage_154] : { state: '0' };
    const stateObj6 = this.hass.states[config.entities.inverter_load_freq_192] ? this.hass.states[config.entities.inverter_load_freq_192] : { state: '0' };
    const stateObj7 = this.hass.states[config.entities.inverter_out_164] ? this.hass.states[config.entities.inverter_out_164] : { state: '0' };
    const stateObj8 = this.hass.states[config.entities.pv2_power_187] ? this.hass.states[config.entities.pv2_power_187] : { state: '0' };
    const stateObj9 = this.hass.states[config.entities.pv1_power_186] ? this.hass.states[config.entities.pv1_power_186] : { state: '0' };
    const stateObj11 = this.hass.states[config.entities.battery_voltage_183] ? this.hass.states[config.entities.battery_voltage_183] : { state: '0' };
    const stateObj12 = this.hass.states[config.entities.battery_soc_184] ? this.hass.states[config.entities.battery_soc_184] : { state: '0' };
    const stateObj13 = this.hass.states[config.entities.battery_out_190] ? this.hass.states[config.entities.battery_out_190] : { state: '0' };
    const stateObj14 = this.hass.states[config.entities.ess_power] ? this.hass.states[config.entities.ess_power] : { state: '0' };
    const stateObj15 = this.hass.states[config.entities.grid_external_power_172] ? this.hass.states[config.entities.grid_external_power_172] : { state: '0' };
    const stateObj16 = this.hass.states[config.entities.pv1_v_109] ? this.hass.states[config.entities.pv1_v_109] : { state: '0' };
    const stateObj17 = this.hass.states[config.entities.pv1_i_110] ? this.hass.states[config.entities.pv1_i_110] : { state: '0' };
    const stateObj18 = this.hass.states[config.entities.pv2_v_111] ? this.hass.states[config.entities.pv2_v_111] : { state: '0' };
    const stateObj19 = this.hass.states[config.entities.pv2_i_112] ? this.hass.states[config.entities.pv2_i_112] : { state: '0' };
    const stateObj20 = this.hass.states[config.entities.grid_status_194] ? this.hass.states[config.entities.grid_status_194] : { state: 'on' };
    const stateObj21 = this.hass.states[config.entities.inverter_status_59] ? this.hass.states[config.entities.inverter_status_59] : { state: 'normal' };
    const stateObj22 = this.hass.states[config.entities.inverter_out_175] ? this.hass.states[config.entities.inverter_out_175] : { state: '0' };
    const stateObj23 = this.hass.states[config.entities.inverter_load_grid_169] ? this.hass.states[config.entities.inverter_load_grid_169] : { state: '0' };
    const stateObj24 = this.hass.states[config.entities.aux_power_166] ? this.hass.states[config.entities.aux_power_166] : { state: '0' };
    const stateObj25 = this.hass.states[config.entities.priority_load_243] ? this.hass.states[config.entities.priority_load_243] : { state: 'undefined' };
    const stateObj26 = this.hass.states[config.entities.use_timer_248] ? this.hass.states[config.entities.use_timer_248] : { state: 'undefined' };;
    ...
    if (config.cardstyle === 'full') {
      return html`
        <div class="container card">
          ...
          <text id="timer_text"x="50%" y="68%" class="${config.entities.use_timer_248 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Timer</text>
          ...
          <text id="priority_text"x="50%" y="73%" class="${config.entities.priority_load_243 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Priority</text>
          </svg>
        </div>
      `;
    }
      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 -0.5 456 380" height="396px" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <text id="timer_text"x="55%" y="67%" class="${config.entities.use_timer_248 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Timer</text>
            ...
            <text id="priority_text"x="55%" y="72%" class="${config.entities.priority_load_243 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Priority</text>
      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 -0.5 483 406" height="396px" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <text id="inverter_grid_voltage_154" x="56%" y="41.5%" class="st3 st9 left-align" >${stateObj5.state ? stateObj5.state : '0'} V</text>
            <text id="inverter_load_freq_192" x="56%" y="44.5%" class="st3 st9 left-align">${stateObj6.state ? stateObj6.state : '0'} Hz</text>
            <text id="inverter_out_164" x="56%" y="47.5%" class="st3 st9 left-align">${stateObj7.state ? stateObj7.state : '0'} A</text>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" id="timer" x="55.5%" y="60%" width="18" height="18" viewBox="0 0 24 24"><path class="${stateObj26.state == 'on' && config.entities.use_timer_248 !== 'no' ? 'st9' : 'st12'}" d="M15 1H9v2h6V1zm-4 13h2V8h-2v6zm8.03-6.61l1.42-1.42c-.43-.51-.9-.99-1.41-1.41l-1.42 1.42A8.962 8.962 0 0 0 12 4c-4.97 0-9 4.03-9 9s4.02 9 9 9a8.994 8.994 0 0 0 7.03-14.61zM12 20c-3.87 0-7-3.13-7-7s3.13-7 7-7s7 3.13 7 7s-3.13 7-7 7z"/></svg>
            <svg xmlns="http://www.w3.org/2000/svg" id="timer_off" x="55.5%" y="60%" width="18" height="18" viewBox="0 0 24 24"><path class="${stateObj26.state == 'off' && config.entities.use_timer_248 !== 'no' ? 'st9' : 'st12'}" d="m19.95 17.15l-1.5-1.5q.275-.675.413-1.337T19 13q0-2.9-2.05-4.95T12 6q-.6 0-1.275.125t-1.4.4l-1.5-1.5q.95-.5 2.012-.763T12 4q1.5 0 2.938.5t2.712 1.45l1.4-1.4l1.4 1.4l-1.4 1.4q.95 1.275 1.45 2.713T21 13q0 1.05-.263 2.087t-.787 2.063ZM13 10.2V8h-2v.2l2 2Zm6.8 12.4l-2.4-2.4q-1.2.875-2.588 1.338T12 22q-1.85 0-3.488-.713T5.65 19.35q-1.225-1.225-1.938-2.863T3 13q0-1.5.463-2.888T4.8 7.6L1.4 4.2l1.4-1.4l18.4 18.4l-1.4 1.4ZM12 20q1.05 0 2.05-.325t1.875-.925L6.2 9.025q-.6.875-.9 1.875T5 13q0 2.9 2.05 4.95T12 20ZM9 3V1h6v2H9Zm2.075 10.875Zm2.825-2.8Z"/></svg>
            <text id="timer_text" x="59.5%" y="62.75%" class="${config.entities.use_timer_248 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Timer</text>
            <svg xmlns="http://www.w3.org/2000/svg" id="pbat" x="55.5%" y="64.75%" width="18" height="18" viewBox="0 0 24 24"><path class="${stateObj25.state === 'off' && config.entities.priority_load_243 !== 'no' ? 'st9' : 'st12'}" d="M15.95 21.175L13.1 18.35l1.425-1.4l1.425 1.4l3.525-3.525l1.425 1.4l-4.95 4.95ZM8 22q-.425 0-.713-.288T7 21V5q0-.425.288-.713T8 4h2V2h4v2h2q.425 0 .713.288T17 5v7q-.525 0-1.025.088T15 12.35V6H9v14h2.35q.2.575.488 1.075t.687.925H8Zm1-2h2.35H11h.35H9Z"/></svg>
            <svg xmlns="http://www.w3.org/2000/svg" id="pload" x="55.5%" y="64.75%" width="18" height="18" viewBox="0 0 24 24"><path class="${stateObj25.state === 'on' && config.entities.priority_load_243 !== 'no' ? 'st9' : 'st12'}" d="m15 13l-4 4v-3H2v-2h9V9l4 4M5 20v-4h2v2h10v-7.81l-5-4.5L7.21 10H4.22L12 3l10 9h-3v8H5Z"/></svg>
            <text id="priority_text"x="59.5%" y="67.25%" class="${config.entities.priority_load_243 !== 'no' ? 'st3 st9 left-align' : 'st12'}">Priority</text>
