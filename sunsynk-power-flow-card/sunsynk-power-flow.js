...
class SunsynkPowerFlowCard extends LitElement {
  ...
  static getStubConfig() {
    return {
        ...
        gridday: "sensor.grid_import_day_buy",
        solarday: "sensor.daily_pv_power_kwh",
    ...
    if (config.cardstyle === 'full') {
      return html`
        <div class="container card">
          ...
          <circle id="selftest" cx="36%" cy="81.75%" r="3.5" fill="${stateObj21.state === '1' ? 'yellow' : 'transparent'}"/>
          <circle id="normal" cx="36%" cy="81.75%" r="3.5" fill="${stateObj21.state === '2' ? 'green' : 'transparent'}"/>
          <circle id="alarm" cx="36%" cy="81.75%" r="3.5" fill="${stateObj21.state === '3' ? 'orange' : 'transparent'}"/>
          <circle id="fault" cx="36%" cy="81.75%" r="3.5" fill="${stateObj21.state === '4' ? 'red' : 'transparent'}"/>
          <circle id="grid" cx="88.5%" cy="98.5%" r="3.5" fill="${stateObj20.state === 'off' ? 'red' : 'transparent'}"/>


          <rect x="51" y="112" width="70" height="30" rx="4.5" ry="4.5" fill="none" stroke="#ff9933" pointer-events="all"/>
          ...
          <rect x="0" y="54" width="70" height="30" rx="4.5" ry="4.5" fill="none" stroke="#ff9933" pointer-events="all"/>
          <rect x="101" y="54" width="70" height="30" rx="4.5" ry="4.5" fill="none" stroke="#ff9933" pointer-events="all"/>
          <rect x="304" y="265" width="70" height="30" rx="4.5" ry="4.5" fill="none" stroke="#558fc1" pointer-events="all"/>


          <path id="pv1-line" d="M 35 92 L 35.02 117 Q 35.03 127 43.02 127 L 51 127" fill="none" stroke="#ff9933" stroke-width="2" stroke-miterlimit="10" stroke-dasharray="2 2" pointer-events="stroke"/>
          <circle id="pv1-dot" cx="0" cy="0" r="3" fill="${stateObj9.state === '0' ? 'transparent' : '#ff9933'}">
            <animateMotion dur="9s" repeatCount="indefinite" keyPoints="0;1" keyTimes="0;1" calcMode="linear">
              <mpath xlink:href="#pv1-line"/>
            </animateMotion>
          </circle>

          <path id="pv2-line" d="M 135 92 L 135.02 117 Q 135.03 127 128.02 127 L 121 127" fill="none" stroke="#ff9933" stroke-width="2" stroke-miterlimit="10" stroke-dasharray="2 2" pointer-events="stroke"/> 
          <circle id="pv2-dot" cx="0" cy="0" r="3" fill="${stateObj8.state === '0' ? 'transparent' : '#ff9933'}">
            <animateMotion dur="9s" repeatCount="indefinite" keyPoints="0;1" keyTimes="0;1" calcMode="linear">
      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 -0.5 456 380" height="396px" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <text id="duration" x="34%" y="89%" class="${config.battery_energy === 'hidden' ? 'st11' : 'st2 st4 left-align'}" >${duration}</text>
            <text id="duration_text" x="34%" y="93%" class="${config.battery_energy === 'hidden' ? 'st11' : 'st2 st3 left-align'}" >BATTERY RUNTIME</text>  
            ...
            <text id="battery_soc_184" x="8%" y="84.5%" class="st2 st4 st8">${stateObj12.state ? stateObj12.state : '0'} %</text>
            <text id="battery_out_190" x="8%" y="90%" class="st2 st4 st8">${stateObj13.state < '0' ? stateObj13.state *-1 : stateObj13.state} W</text>
            ...
            <circle id="normal" cx="41%" cy="81.75%" r="3.5" fill="${stateObj21.state === '2' ? 'green' : 'transparent'}"/>
            <circle id="alarm" cx="41%" cy="81.75%" r="3.5" fill="${stateObj21.state === '3' ? 'orange' : 'transparent'}"/>
            <circle id="fault" cx="41%" cy="81.75%" r="3.5" fill="${stateObj21.state === '4' ? 'red' : 'transparent'}"/>
            ...
            <rect x="0" y="54" width="70" height="30" rx="4.5" ry="4.5" fill="none" stroke="#ff9933" pointer-events="all"/>
            <rect x="101" y="54" width="70" height="30" rx="4.5" ry="4.5" fill="none" stroke="#ff9933" pointer-events="all"/>
            <rect x="0" y="284.75" width="70" height="70" rx="10.5" ry="10.5" fill="none" stroke="#f3b1c9" pointer-events="all"/>

            <path id="bat-line" d="M 179 259.87 L 105.03 259.89 Q 95.03 259.9 95.03 269.86 L 95.03 279.83" fill="none" stroke="#f3b1c9" stroke-width="2" stroke-miterlimit="10" stroke-dasharray="2 2" pointer-events="stroke"/>
            <circle id="power-dot-charge" cx="0" cy="0" r="3" fill="${parseInt(stateObj13.state) < '0' ? 'transparent' : '#f3b1c9'}">
              <animateMotion dur="6s" repeatCount="indefinite" keyPoints="1;0" keyTimes="0;1" calcMode="linear">
                <mpath xlink:href="#bat-line"/>
              </animateMotion>
            ...
            <image x="178.5" y="219.5" width="50.3" height="79.75" xlink:href="data:image/png;base64," preserveAspectRatio="none"/><rect x="0" y="284.75" width="70" height="70" rx="10.5" ry="10.5" fill="none" stroke="#f3b1c9" pointer-events="all"/>
            <svg xmlns="http://www.w3.org/2000/svg" id="bat-high" x="73.5" y="279.25" width="82" height="82" preserveAspectRatio="none" opacity="${parseInt(stateObj12.state) > '80' ? '1' : '0'}" viewBox="0 0 24 24"><path fill="#f3b1c9" d="M12 20H4V6h8m.67-2H11V2H5v2H3.33C2.6 4 2 4.6 2 5.33v15.34C2 21.4 2.6 22 3.33 22h9.34c.74 0 1.33-.59 1.33-1.33V5.33C14 4.6 13.4 4 12.67 4M11 16H5v3h6v-3m0-9H5v3h6V7m0 4.5H5v3h6v-3M23 10h-3V3l-5 10h3v8"/></svg>
            <svg xmlns="http://www.w3.org/2000/svg" id="bat-med" x="73.5" y="279.25" width="82" height="82" preserveAspectRatio="none" opacity="${parseInt(stateObj12.state) >= 50 && parseInt(stateObj12.state) <= 80 ? '1' : '0'}" viewBox="0 0 24 24"><path fill="#f3b1c9" d="M12 20H4V6h8m.67-2H11V2H5v2H3.33C2.6 4 2 4.6 2 5.33v15.34C2 21.4 2.6 22 3.33 22h9.34c.74 0 1.33-.59 1.33-1.33V5.33C14 4.6 13.4 4 12.67 4M11 16H5v3h6v-3m0-4.5H5v3h6v-3M23 10h-3V3l-5 10h3v8"/></svg>
            <svg xmlns="http://www.w3.org/2000/svg" id="bat-low" x="73.5" y="279.25" width="82" height="82" preserveAspectRatio="none" opacity="${parseInt(stateObj12.state) > 30 && parseInt(stateObj12.state) <= 49 ? '1' : '0'}" viewBox="0 0 24 24"><path fill="#f3b1c9" d="M12 20H4V6h8m.67-2H11V2H5v2H3.33C2.6 4 2 4.6 2 5.33v15.34C2 21.4 2.6 22 3.33 22h9.34c.74 0 1.33-.59 1.33-1.33V5.33C14 4.6 13.4 4 12.67 4M11 16H5v3h6v-3m12-6h-3V3l-5 10h3v8"/></svg>
            <svg xmlns="http://www.w3.org/2000/svg" id="bat-empty" x="73.5" y="279.25" width="82" height="82" preserveAspectRatio="none" opacity="${parseInt(stateObj12.state) <= 30 ? '1' : '0'}" viewBox="0 0 24 24"><path fill="#f3b1c9" d="M23.05 11h-3V4l-5 10h3v8M12 20H4l.05-14h8m.67-2h-1.67V2h-6v2H3.38a1.33 1.33 0 0 0-1.33 1.33v15.34c0 .73.6 1.33 1.33 1.33h9.34c.73 0 1.33-.6 1.33-1.33V5.33A1.33 1.33 0 0 0 12.72 4Z"/></svg>
      ...
      return html`
        <div class="container card">
          <svg viewBox="-0.5 -0.5 483 406" height="396px" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <text id="daily_solar_value" x="47%" y="4%" class="${config.dailyusage === 'no' ? 'st11' : 'st10 st1 left-align'}" >${stateObj4.state ? stateObj4.state : '0'} kWh</text>
            <text id="daily_solar" x="47%" y="7.5%" class="${config.dailyusage === 'no' ? 'st11' : 'st3 st1 left-align'}" >DAILY SOLAR</text>
            <text id="inverter_grid_voltage_154" x="56%" y="63.25%" class="st3 st9 left-align" >${stateObj5.state ? stateObj5.state : '0'} V</text>
            <text id="inverter_load_freq_192" x="56%" y="66.25%" class="st3 st9 left-align">${stateObj6.state ? stateObj6.state : '0'} Hz</text>
            ...
            <text id="pv1_v" x="25%" y="16%" class="st3 st1 left-align" >${stateObj16.state ? stateObj16.state : '0'} V</text>
            <text id="pv1_i" x="25%" y="19%" class="st3 st1 left-align" >${stateObj17.state ? stateObj17.state : '0'} A</text>
            <text id="pv2_v" x="68.75%" y="16%" class="st3 st1 left-align" >${stateObj18.state ? stateObj18.state : '0'} V</text>
            <text id="pv2_i" x="68.75%" y="19%" class="st3 st1 left-align" >${stateObj19.state ? stateObj19.state : '0'} A</text>

            <circle id="standby" cx="54%" cy="65%" r="3.5" fill="${stateObj21.state === '0' ? 'blue' : 'transparent'}"/>
            <circle id="selftest" cx="54%" cy="66%" r="3.5" fill="${stateObj21.state === '1' ? 'yellow' : 'transparent'}"/>
            <circle id="normal" cx="54%" cy="66%" r="3.5" fill="${stateObj21.state === '2' ? 'green' : 'transparent'}"/>
            <circle id="alarm" cx="54%" cy="66%" r="3.5" fill="${stateObj21.state === '3' ? 'orange' : 'transparent'}"/>
            <circle id="fault" cx="54%" cy="66%" r="3.5" fill="${stateObj21.state === '4' ? 'red' : 'transparent'}"/>
            <circle id="grid" cx="6.5%" cy="62%" r="3.5" fill="${stateObj20.state === 'off' ? 'red' : 'transparent'}"/>

            <path id="pv1-line" d="M 189 84.5 L 189 122.03 Q 189 132.03 197 132.03 L 205 132.03" fill="none" stroke="#ff9933" stroke-width="2" stroke-miterlimit="10" stroke-dasharray="2 2" pointer-events="stroke"/>
            <circle id="pv1-dot" cx="0" cy="0" r="3" fill="${stateObj9.state === '0' ? 'transparent' : '#ff9933'}">
              <animateMotion dur="9s" repeatCount="indefinite" keyPoints="0;1" keyTimes="0;1" calcMode="linear">
                <mpath xlink:href="#pv1-line"/>
              </animateMotion>
            ...
            <path id="pv2-line" d="M 289 84.5 L 289 121.48 Q 289 131.48 282 131.49 L 275 131.5" fill="none" stroke="#ff9933" stroke-width="2" stroke-miterlimit="10" stroke-dasharray="2 2" pointer-events="stroke"/>
            <circle id="pv2-dot" cx="0" cy="0" r="3" fill="${stateObj8.state === '0' ? 'transparent' : '#ff9933'}">
              <animateMotion dur="9s" repeatCount="indefinite" keyPoints="0;1" keyTimes="0;1" calcMode="linear">
                <mpath xlink:href="#pv2-line"/>  
              </animateMotion>
            ...
            <rect x="205" y="116.5" width="70" height="30" rx="4.5" ry="4.5" fill="none" stroke="#ff9933" pointer-events="all"/>
            ...
            <image x="160" y="0" width="56" height="56" xlink:href="data:image/png;base64," preserveAspectRatio="none"/>
            ...
            <rect x="154" y="54.5" width="70" height="30" rx="4.5" ry="4.5" fill="none" stroke="#ff9933" pointer-events="all"/>
            <rect x="254" y="54.5" width="70" height="30" rx="4.5" ry="4.5" fill="none" stroke="#ff9933" pointer-events="all"/>
          </svg>
        </div>
      `;
    }
