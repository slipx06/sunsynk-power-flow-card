...
export class FoxESS extends InverterSettingsDto {
	...
	statusGroups: InverterStatus = {
		...
		fault: {
			states: ['recoverable fault', 'unrecoverable fault'],
			color: 'red',
