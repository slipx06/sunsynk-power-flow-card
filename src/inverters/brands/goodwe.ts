...
export class Goodwe extends InverterSettingsDto {
	brand = InverterModel.Goodwe;
	batteryStatusGroups: InverterStatus = {
		noBattery: {
			states: ['0'],
			color: 'yellow',
			message: localize('common.no_battery'),
		},
		standby: {
			states: ['1'],
			color: 'blue',
		...
		charging: {
			states: ['3'],
			color: 'green',
			message: localize('common.charging'),
		},
		waiting: {
			states: ['4', '5'],
			color: 'yellow',
			message: localize('common.waiting'),
		},
	};
