...
//https://github.com/home-assistant/core/blob/57cc3495c2a26b7ba29d8f9f252238865e6132e1/homeassistant/components/fronius/const.py#L49C1-L64C43
...
export class Fronius extends InverterSettingsDto {
	...
	statusGroups: InverterStatus = {
		...
		fault: { states: ['255'], color: 'red', message: localize('common.fault') },
	};
}
