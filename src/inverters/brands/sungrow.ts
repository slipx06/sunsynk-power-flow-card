...
export class Sungrow extends InverterSettingsDto {
	...
	statusGroups: InverterStatus = {
		...
		shutdown: {
			states: ['shutdown', 'restarting', 'afci self test shutdown'],
			color: 'red',
