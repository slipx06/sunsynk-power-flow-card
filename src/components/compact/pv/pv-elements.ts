...
export const renderSolarElements = (data: DataDto, config: sunsynkPowerFlowCardConfig) => {
    ...
    return html`
        ...
        <svg id="Solar" 
            ...
            <svg id="PV5" 
                style="overflow: visible; display: ${config.show_solar && config.wide && [5, 6].includes(mppts)  ? 'inline' : 'none'};" x="-10.5%">
            ...
            <svg id="PV6" 
                style="overflow: visible; display: ${config.show_solar && config.wide && mppts === 6  ? 'inline' : 'none'};" x="10.5%">
            ...
            ${createTextWithPopup(
                ...
                296,
                106,
                !config.entities.pv2_voltage_111 || config.entities.pv2_voltage_111 === 'none' || mppts === 1 || !data.statePV2Voltage.isValid(),
                'st3 left-align',
                solarColour,
            ...
            ${createTextWithPopup(
                ...
                296,
                94,
                !config.entities.pv2_current_112 || config.entities.pv2_current_112 === 'none' || mppts === 1 || !data.statePV2Current.isValid(),
                'st3 left-align',
                solarColour,
            ...
            ${createTextWithPopup(
                ...
                120,
                106,
                !config.entities.pv3_voltage_113 || config.entities.pv3_voltage_113 === 'none' || [1, 2].includes(mppts) || !data.statePV3Voltage.isValid(),
                'st3 left-align',
                solarColour,
            ...
            ${createTextWithPopup(
                ...
                120,
                94,
                !config.entities.pv3_current_114 || config.entities.pv3_current_114 === 'none' || [1, 2].includes(mppts) || !data.statePV3Current.isValid(),
                'st3 left-align',
                solarColour,
            ...
            ${createTextWithPopup(
                ...
                372,
                106,
                !config.entities.pv4_voltage_115 || config.entities.pv4_voltage_115 === 'none' || [1, 2, 3].includes(mppts) || !data.statePV4Voltage.isValid(),
                'st3 left-align',
                solarColour,
            ...
            ${createTextWithPopup(
                ...
                372,
                94,
                !config.entities.pv4_current_116 || config.entities.pv4_current_116 === 'none' || [1, 2, 3].includes(mppts) || !data.statePV4Current.isValid(),
                'st3 left-align',
                solarColour,
