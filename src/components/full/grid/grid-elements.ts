        ...
        x="${config.wide ? '30%' : '3%'}" y="2.5%">
            ...
            <svg id="nonessential3" style="overflow: visible">
                <rect id="noness3" x="266" y="310" width="35" height="20" rx="4.5" ry="4.5"
                    display="${nonessentialLoads === 3 && (config.battery.hide_soc || config.wide) ? '' : 'none'}"
                ...
                ${createTextWithPopup(
                    ...
                    283,
                    321,
                    !showNonessential || [0, 1, 2].includes(nonessentialLoads) || !data.stateNonessentialLoad3.isValid(),
                ...
                ${createTextWithPopup(
                    ...
                    300,
                    305,
                    config.entities?.non_essential_load3_extra && nonessentialLoads === 3 && data.stateNonEssentialLoad3Extra.isValid() && config.show_grid && config.wide && showNonessential,
                    'st3 right-align',
                    data.dynamicColourNonEssentialLoad3,
            ...
            <rect id="noness1" x="304" y="310" width="70" height="20" rx="4.5" ry="4.5"
                display="${nonessentialLoads === 1 ? '' : 'none'}" fill="none"
            ...
            ${renderText(
                ...
                !showNonessential ? '368' : (config.entities?.max_sell_power ? '256' : '253'),
            ...
            ${renderText(
                'daily_grid_sell',
                !showNonessential ? '311' : '347',
                !showNonessential ? '337' : (config.entities?.max_sell_power ? '225' : '222'),
            ...
            <g display="${!showNonessential || [1, 2, 3].includes(nonessentialLoads) ? 'none' : ''}">
                ${renderIcon(
                    undefined,
            ...
            <g display="${!showNonessential || [0, 1].includes(nonessentialLoads) ? 'none' : ''}">
                ${renderIcon(
                    undefined, 
            ...
            <g display="${!showNonessential || [0, 2, 3].includes(nonessentialLoads) ? 'none' : ''}">
                ${renderIcon(
                    undefined,
                    data.iconNonessentialLoad1,
                    'nonessload1-icon',
            ...
            ${createTextWithPopup(
                ...
                !showNonessential ? '311' : '347',
                !showNonessential ? '354' : (config.entities?.max_sell_power ? '242' : '239'),
            ...
            ${createTextWithPopup(
                ...
                !showNonessential ? '311' : '347',
                !showNonessential ? '323' : (config.entities?.max_sell_power ? '212' : '209'),
                        ...
                        ${createTextWithPopup(
                            ...
                            auto_scale
                                ? `${config.grid.show_absolute
                                        ...
                                        : Utils.convertValue(totalGridPower, decimalPlaces) || 0}`
                                : `${config.grid.show_absolute
                                        ? `${Math.abs(totalGridPower)} ${UnitOfPower.WATT}`
                                        : `${totalGridPower || 0} ${UnitOfPower.WATT}`}`,
                            (e) => Utils.handlePopup(e, config.entities.grid_ct_power_total),
                            true
                        )}`
                    : svg`
                        ${renderText(
            ...
            ${config.entities?.nonessential_power && config.entities.nonessential_power !== 'none'
                ? svg`
                    ${createTextWithPopup(
                        ...
                        (e) => Utils.handlePopup(e, config.entities.nonessential_power),
                        true
                    )}`
                : svg`
                    ${renderText(
                ...
                ? svg`
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.energy_cost_buy)}>
                        ${renderText(
                            ...
                            414,
                            305,
                            !!(config.entities?.energy_cost_buy && data.stateEnergyCostBuy.isValid() && !config.entities.non_essential_load2_extra),
                            'st3 right-align',
                            gridColour,
                ...
                : svg`
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.energy_cost_sell)}>
                        ${renderText(
                            ...
                            414,
                            305,
                            !!(config.entities?.energy_cost_sell && data.stateEnergyCostSell.isValid() && !config.entities.non_essential_load2_extra),
                            'st3 right-align',
                            gridColour,
            ...
            ${createTextWithPopup(
                ...
                340,
                321,
                !showNonessential || [0, 2, 3].includes(nonessentialLoads) || !data.stateNonessentialLoad1.isValid(),
                'st3',
                data.dynamicColourNonEssentialLoad1,
            ...
            ${createTextWithPopup(
                ...
                320,
                321,
                !showNonessential || [0, 1].includes(nonessentialLoads) || !data.stateNonessentialLoad1.isValid(),
                'st3',
                data.dynamicColourNonEssentialLoad1,
                data.stateNonessentialLoad1.toPowerString(auto_scale, decimalPlaces),
                (e) => Utils.handlePopup(e, config.entities.non_essential_load1),
            ...
            ${createTextWithPopup(
                ...
                357,
                321,
                !showNonessential || [0, 1].includes(nonessentialLoads) || !data.stateNonessentialLoad2.isValid(),
                'st3',
                data.dynamicColourNonEssentialLoad2,
            ...
            ${createTextWithPopup(
                ...
                335,
                305,
                config.entities?.non_essential_load1_extra && [1, 2, 3].includes(nonessentialLoads) && data.stateNonEssentialLoad1Extra.isValid() && config.show_grid && showNonessential,
                'st3 right-align',
                data.dynamicColourNonEssentialLoad1,
            ...
            ${createTextWithPopup(
                ...
                342,
                305,
                config.entities?.non_essential_load2_extra && [2, 3].includes(nonessentialLoads) && data.stateNonEssentialLoad2Extra.isValid() && config.show_grid && showNonessential,
                'st3 left-align',
                data.dynamicColourNonEssentialLoad2,
