        ...
        <ha-card>
            ...
            <div class="container card">
                ${config.title ? html`<h1
                        style="text-align: center; color: ${config.title_colour || 'inherit'}; data.font-size: ${config.title_size || '32px'};">
                    ${config.title}</h1>` : ''}
                <svg viewBox="-0.5 ${!config.show_solar ? (data.additional_load !== 0 || !config.show_battery ? 80 : 145.33) : -0.5} 483 ${!config.show_solar ? (config.show_battery ? (data.additional_load !== 0 ? 350 : 270.67) : 270.67) : (!config.show_battery ? (data.additional_load === 2 ? 350 : 300) : 406)}"
                     preserveAspectRatio="xMidYMid meet"
                     height="${data.panel === false ? `${!config.show_solar && !config.show_battery ? '270px' : !config.show_solar ? (data.additional_load !== 0 ? '330px' : '246px') : config.show_solar && !config.show_battery ? (data.additional_load === 2 ? '350px' : '300px') : `${data.height}`}` : `${!config.show_solar ? '75%' : '100%'}`}"
                    ...
                    <rect x="205" y="290" width="70" height="30" rx="4.5" ry="4.5" fill="none"
                          ...
                          class="${data.compact ? '' : 'st12'}"/>
                    <rect x="159" y="${data.compact ? '348' : '329.75'}" width="70"
                          height="${data.compact ? '50' : '70'}"
                          rx="${data.compact ? '7.5' : '10.5'}" ry="${data.compact ? '7.5' : '10.5'}" fill="none"
                          stroke="${data.bat_colour}" pointer-events="all"
                          display="${!config.show_battery ? 'none' : ''}"
                          class="${data.compact ? 'st12' : ''}"/>
                    ...
                    <rect id="pv1" x="${config.solar.mppts === 1 ? '205' : '154'}" y="54.5" width="70"
                          height="30" rx="4.5" ry="4.5" fill="none" stroke="${data.solar_colour}"
                    ...
                    <rect id="es-load4" x="405" y="127" width="35" height="20" rx="4.5" ry="4.5" fill="none"
                          stroke="${data.load_colour}" pointer-events="all"
                          display="${data.additional_load === 4 ? '' : 'none'}"/>
                    ...
                    <text id="duration" x="${data.compact ? '270' : '290'}" y="377.5"
                          class="${data.font !== true ? 'st14' : 'st4'} left-align"
                          display="${!config.show_battery ? 'none' : ''}"
                          fill="${data.battery_energy === 0 || data.isFloating || data.battery_power === 0 ? 'transparent' : `${data.bat_colour}`}">
                        ${data.duration}
                    </text>
                    <text id="duration_text" x="${data.compact ? '270' : '290'}" y="393.7" class="st3 left-align"
                          display="${!config.show_battery ? 'none' : ''}"
                    ...
                    <text id="duration_text_charging" x="${data.compact ? '270' : '290'}" y="393.7"
                    ...
                    <text id="floating" x="${data.compact ? '270' : '290'}" y="393.7" class="st3 left-align"
                          display="${!config.show_battery ? 'none' : ''}"
                          fill="${data.battery_energy === 0 || !data.isFloating ? 'transparent' : `${data.bat_colour}`}">
                        ${localize('common.battery_floating')}
                    </text>
                    <text id="daily_bat_charge" x="${data.compact ? '132' : '77.2'}" y="357.2" class="st3 left-align"
                          fill="${data.battery_showdaily !== true || !config.show_battery ? 'transparent' : `${data.bat_colour}`}">
                        ${localize('common.daily_charge')}
                    </text>
                    <text id="daily_bat_dischcharge" x="${data.compact ? '132' : '77.2'}" y="393.7"
                          class="st3 left-align"
                          fill="${data.battery_showdaily !== true || !config.show_battery ? 'transparent' : `${data.bat_colour}`}">
                        ${localize('common.daily_discharge')}
                    </text>
                    <text id="daily_load" x="${[2, 4].includes(data.additional_load) ? '365' : '412'}"
                          y="${[2, 4].includes(data.additional_load) ? '189' : '282.1'}"
                          class="st3 left-align"
                          fill="${!data.load_showdaily ? 'transparent' : `${data.load_colour}`}">
                    ...
                    <text id="es-load1" x="441" y="108" class="st3"
                          display="${[1, 2].includes(data.additional_load) ? '' : 'none'}"
                          fill="${data.load_colour}">${config.load?.load1_name ? `${config.load.load1_name}` : ''}
                    </text>
                    ...
                    <text id="es-load4" x="423" y="156" class="st3 st8"
                          display="${data.additional_load === 4 ? '' : 'none'}" fill="${data.load_colour}">
                    ...
                    <text id="load-power-L1" x="375" y="241"
                        ...
                        ${config.load.auto_scale ? `${Utils.convertValue(data.load_power_L1, data.round) || 0}` : `${data.load_power_L1 || 0} W`}
                    </text>
                    <text id="load-power-L2" x="375" y="254"
                          display="${config.inverter.three_phase && config.entities?.load_power_L2 ? '' : 'none'}"
                          class="st3 left-align" fill="${data.load_colour}">
                        ${config.load.auto_scale ? `${Utils.convertValue(data.load_power_L2, data.round) || 0}` : `${data.load_power_L2 || 0} W`}
                    </text>
                    <text id="load-power-L3" x="375" y="267"
                          display="${config.inverter.three_phase && config.entities?.load_power_L3 ? '' : 'none'}"
                          class="st3 left-align" fill="${data.load_colour}">
                        ${config.load.auto_scale ? `${Utils.convertValue(data.load_power_L3, data.round) || 0}` : `${data.load_power_L3 || 0} W`}
                    </text>
                    ...
                    <text x="169" y="${!config.battery.show_remaining_energy ? '320' : '311'}" class="st3 left-align"
                          display="${!config.show_battery || data.compact ? 'none' : ''}" fill="${data.bat_colour}">
                        ${data.batteryStateMsg}
                    </text>
                    <text x="${data.compact ? '270' : !config.entities?.battery_status ? '193' : '169'}"
                          y="${data.compact ? '338' : '323'}"
                          class="${!config.entities?.battery_status && !data.compact ? 'st3' : 'st3 left-align'}"
                          display="${!config.show_battery || !config.battery.show_remaining_energy ? 'none' : ''}"
                          fill="${data.bat_colour}">
                        ${Utils.toNum(((data.battery_energy * (parseFloat(data.state_battery_soc.data.state) / 100) / 1000)), 2)}
                        kWh
                    </text>
                    <text id="battery_soc_184" x="${data.compact ? '348.5' : '368.5'}" y="351" fill=${data.bat_colour}
                    ...
                    <text id="battery_soc_184" x="${data.compact ? '348.5' : '368.5'}" y="364" fill=${data.bat_colour}
                          class="${config.battery.hide_soc || !config.show_battery ? 'st12' : 'st14 left-align'}"
                          display="${[InverterModel.GoodweGridMode, InverterModel.Goodwe, InverterModel.Huawei].includes(data.inverterModel) && config.battery?.shutdown_soc_offgrid ? '' : 'none'}">
                    ...
                    <circle id="bat" cx="${data.compact ? '238.5' : '162'}"
                            cy="${data.compact
                                    ? '326'
                    ...
                    <svg id="battery-flow">
                        <path id="bat-line"
                              d="${data.compact ? 'M 239 250 L 239 290' : 'M 239 250 L 239 324'}"
                    ...
                    <svg id="grid-flow">
                        <path id="grid-line" d="M 173 218 L 214 218" fill="none" stroke="${data.grid_colour}"
                    ...
                    <svg id="grid1-flow">
                        <path id="grid-line1" d="M 103 218 L 64.5 218" fill="none" stroke="${data.grid_colour}"
                              stroke-width="${data.gridLineWidth}" stroke-miterlimit="10" pointer-events="stroke"
                              display="${!config.show_grid ? 'none' : ''}"/>
                    ...
                    <svg id="load-flow">
                        <path id="es-line" d="M 304 218.5 L 264.7 218.5" fill="none" stroke="${data.load_colour}"
                    ...
                    <svg id="load-flow1">
                        <path id="es-line1" d="M 374 218.5 L 402.38 218.5" fill="none" stroke="${data.load_colour}"
                              stroke-width="${data.loadLineWidth}" stroke-miterlimit="10" pointer-events="stroke"/>
                        <circle id="es-dot" cx="0" cy="0"
                                r="${Math.min(2 + data.loadLineWidth + Math.max(data.min_linewidth - 2, 0), 8)}"
                                fill="${data.essential === 0 ? 'transparent' : `${data.load_colour}`}">
                    ...
                    <path id="es-load1" d="M 441 180 L 441 147" class="${data.additional_load === 1 ? '' : 'st12'}"
                          fill="none" stroke="${data.load_colour}" stroke-width="1" stroke-miterlimit="10"
                          pointer-events="stroke"/>
                    <path id="es-load1" d="M 441 180 L 441 147"
                          class="${[2, 4].includes(data.additional_load) ? '' : 'st12'}" fill="none"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" id="ess_oven_top" x="368" y="113" width="36"
                         ...
                         opacity="${data.load1e_icon === 'oven' && [1, 2].includes(data.additional_load) ? '1' : '0'}">
                        <path display="${data.additional_load === 0 ? 'none' : ''}" fill="${data.load_colour}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" id="ess_pump_top" x="368" y="113" width="36"
                         ...
                         opacity="${data.load1e_icon === 'pump' && [1, 2].includes(data.additional_load) ? '1' : '0'}">
                        <path display="${data.additional_load === 0 ? 'none' : ''}" fill="${data.load_colour}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" id="ess_ac_top" x="374" y="116" width="30"
                         ...
                         opacity="${data.load1e_icon === 'aircon' && [1, 2].includes(data.additional_load) ? '1' : '0'}">
                        <path display="${data.additional_load === 0 ? 'none' : ''}" fill="${data.load_colour}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" id="ess_boiler_top" x="371" y="113" width="36"
                         height="36" viewBox="0 0 24 24"
                         opacity="${data.load1e_icon === 'boiler' && [1, 2].includes(data.additional_load) ? '1' : '0'}">
                        <path display="${data.additional_load === 0 ? 'none' : ''}" fill="${data.load_colour}"
                    ...
                    <g display="${[0, 4].includes(data.additional_load) ? 'none' : ''}">
                    ...
                    <g display="${[0, 1, 4].includes(data.additional_load) ? 'none' : ''}">
                    ...
                    <g display="${data.additional_load === 4 ? '' : 'none'}">
                        <foreignObject x="412" y="101" width="30" height="30" style="position: fixed; ">
                            <body xmlns="http://www.w3.org/1999/xhtml">
                            <div style="position: fixed; ">
                                <ha-icon icon="${data.load1e_icon}" class="essload_small-icon"></ha-icon>
                            </div>
                            </body>
                        </foreignObject>
                    </g>
                    ...
                    <g display="${data.additional_load === 4 ? '' : 'none'}">
                        <foreignObject x="449" y="101" width="30" height="30" style="position: fixed; ">
                            <body xmlns="http://www.w3.org/1999/xhtml">
                            <div style="position: fixed; ">
                                <ha-icon icon="${data.load2e_icon}" class="essload_small-icon"></ha-icon>
                            </div>
                            </body>
                        </foreignObject>
                    </g>
                    ...
                    <g display="${data.additional_load === 4 ? '' : 'none'}">
                        <foreignObject x="412" y="264" width="30" height="30" style="position: fixed; ">
                            <body xmlns="http://www.w3.org/1999/xhtml">
                            <div style="position: fixed; ">
                                <ha-icon icon="${data.load3e_icon}" class="essload_small-icon"></ha-icon>
                            </div>
                            </body>
                        </foreignObject>
                    </g>
                    ...
                    <g display="${data.additional_load === 4 ? '' : 'none'}">
                        <foreignObject x="449" y="264" width="30" height="30" style="position: fixed; ">
                            <body xmlns="http://www.w3.org/1999/xhtml">
                            <div style="position: fixed; ">
                                <ha-icon icon="${data.load4e_icon}" class="essload_small-icon"></ha-icon>
                            </div>
                            </body>
                        </foreignObject>
                    </g>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" id="bat" x="${data.compact ? '212.5' : '232.5'}"
                         y="325.5" width="78.75"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" id="essen" x="${data.essIconSize === 1 ? "405" : "402"}"
                        ...
                        <path fill="${config.load.dynamic_colour ? 'url(#Lg)' : data.load_colour}"
                              d="${data.essIcon}"/>
                    </svg>
                    ...
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.use_timer_248)}>
                        <svg xmlns="http://www.w3.org/2000/svg" id="timer" x="267.7" y="243.3" width="18"
                            ...
                            <path display="${data.state_use_timer.data.state == 'on' && data.usetimer !== false ? '' : 'none'}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" id="timer_off" x="267.7" y="243.3" width="18"
                             height="18" viewBox="0 0 24 24">
                            <path display="${data.state_use_timer.data.state == 'off' && data.usetimer !== false ? '' : 'none'}"
                                  fill="${data.inverter_colour}"
                        ...
                        <text id="timer_text_off" x="287" y="254.7" class="st3 left-align"
                              display="${data.state_use_timer.data.state == 'off' && data.usetimer !== false ? '' : 'none'}"
                              fill="${data.inverter_colour}">${localize('common.timer_off')}
                        </text>
                        <text id="timer_text_on" x="287" y="254.7" class="st3 left-align"
                              display="${data.state_use_timer.data.state == 'on' && data.usetimer !== false ? '' : 'none'}"
                    ...
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.solar_sell_247)}>
                        <svg xmlns="http://www.w3.org/2000/svg" id="solar_sell_on" x="245" y="150" width="18"
                            ...
                            <path display="${!config.entities.solar_sell_247 || data.state_solar_sell.data.state === 'off' || data.state_solar_sell.data.state === '0' || !config.show_solar || !['1', 'on'].includes(data.state_solar_sell.data.state) ? 'none' : ''}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" id="solar_sell_off" x="245" y="150" width="18"
                             height="18" viewBox="0 0 30 30">
                            <path display="${!config.entities.solar_sell_247 || data.state_solar_sell.data.state === 'on' || data.state_solar_sell.data.state === '1' || !config.show_solar || !['0', 'off'].includes(data.state_solar_sell.data.state) ? 'none' : ''}"
                                  fill="${data.solar_colour}"
                    ...
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.day_battery_charge_70)}>
                        <text id="daily_bat_charge_value" x="${data.compact ? '132' : '77.2'}" y="343"
                              class="st10 left-align"
                              display="${data.battery_showdaily !== true || !config.show_battery ? 'none' : ''}"
                              fill="${data.bat_colour}">
                            ${config.battery.auto_scale
                                    ? Utils.convertValueNew(data.state_day_battery_charge.data.state, data.state_day_battery_charge.attributes?.unit_of_measurement, 1)
                                    : `${Utils.toNum(data.state_day_battery_charge.data.state, 1)} kWh`
                            }
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.day_pv_energy_108)}>
                        <text id="daily_solar_value" x="200" y="26" class="st10 left-align"
                            ...
                            ${config.solar.auto_scale
                                    ? Utils.convertValueNew(data.state_day_pv_energy.data.state, data.state_day_pv_energy.attributes?.unit_of_measurement, 1)
                                    : `${Utils.toNum(data.state_day_pv_energy.data.state, 1)} kWh`
                            }
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.day_pv_energy_108)}>
                        <text id="remaining_solar_value" x="200" y="26" class="st10 left-align"
                              ...
                              fill="${!data.solar_showdaily || !config.show_solar ? 'transparent' : `${data.solar_colour}`}">
                            ${config.solar.auto_scale
                                    ? `${Utils.convertValueNew(data.state_day_pv_energy.data.state, data.state_day_pv_energy.attributes?.unit_of_measurement, 1)} / ${data.remaining_solar}`
                                    : `${Utils.toNum(data.state_day_pv_energy.data.state, 1)} kWh / ${data.remaining_solar}`
                            }
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.day_pv_energy_108)}>
                        <text id="total_solar_value" x="200" y="26" class="st10 left-align"
                              ...
                              fill="${!data.solar_showdaily || !config.show_solar ? 'transparent' : `${data.solar_colour}`}">
                            ${config.solar.auto_scale
                                    ? `${Utils.convertValueNew(data.state_day_pv_energy.data.state, data.state_day_pv_energy.attributes?.unit_of_measurement, 1)} / ${data.total_solar_generation}`
                                    : `${Utils.toNum(data.state_day_pv_energy.data.state, 1)} kWh / ${data.total_solar_generation}`
                            }
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.day_battery_discharge_71)}>
                        <text id="daily_bat_discharge_value" x="${data.compact ? '132' : '77.2'}" y="380.1"
                              class="st10 left-align"
                              display="${data.battery_showdaily !== true || !config.show_battery ? 'none' : ''}"
                              fill="${data.bat_colour}">
                            ${config.battery.auto_scale
                                    ? Utils.convertValueNew(data.state_day_battery_discharge.data.state, data.state_day_battery_discharge.attributes?.unit_of_measurement, 1)
                                    : `${Utils.toNum(data.state_day_battery_discharge.data.state, 1)} kWh`
                            }
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.day_load_energy_84)}>
                        <text id="daily_load_value"
                              x="${[2, 4].includes(data.additional_load) ? '365' : '412'}"
                              y="${[2, 4].includes(data.additional_load) ? '175' : '267.9'}"
                              class="st10 left-align" display="${!data.load_showdaily ? 'none' : ''}"
                              fill="${data.load_colour}">
                            ${config.load.auto_scale
                                    ? Utils.convertValueNew(data.state_day_load_energy.data.state, data.state_day_load_energy.attributes?.unit_of_measurement, 1)
                                    : `${Utils.toNum(data.state_day_load_energy.data.state, 1)} kWh`
                            }
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.day_grid_import_76)}>
                        <text id="daily_grid_buy_value" x="5" y="267.9" class="st10 left-align"
                            ...
                            ${config.grid.auto_scale
                                    ? Utils.convertValueNew(data.state_day_grid_import.data.state, data.state_day_grid_import.attributes?.unit_of_measurement, 1)
                                    : `${Utils.toNum(data.state_day_grid_import.data.state, 1)} kWh`
                            }
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.day_grid_export_77)}>
                        <text id="daily_grid_sell_value" x="5" y="165" class="st10 left-align"
                              ...
                              fill="${data.grid_colour}">
                            ${config.grid.auto_scale
                                    ? Utils.convertValueNew(data.state_day_grid_export.data.state, data.state_day_grid_export.attributes?.unit_of_measurement, 1)
                                    : `${Utils.toNum(data.state_day_grid_export.data.state, 1)} kWh`
                            }
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.inverter_voltage_154)}>
                        <text id="inverter_voltage_154" x="270.2" y="168.2"
                              ...
                              class="st3 left-align" fill="${data.inverter_colour}">${data.inverter_voltage}
                            ${config.inverter.three_phase && config.entities?.inverter_voltage_L2 ? '| ' + data.inverter_voltage_L2 : ''}
                            ${config.inverter.three_phase && config.entities?.inverter_voltage_L3 ? '| ' + data.inverter_voltage_L3 : ''}
                            V
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.load_frequency_192)}>
                        <text id="load_frequency_192" x="270.2" y="192.6"
                              ...
                              class="st3 left-align" fill="${data.inverter_colour}">${data.load_frequency} Hz
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.inverter_current_164)}>
                        <text id="inverter_current_164" x="270.2" y="180.4"
                              ...
                              class="st3 left-align" fill="${data.inverter_colour}">${data.inverter_current}
                            ${config.inverter.three_phase && config.entities?.inverter_current_L2 ? '| ' + data.inverter_current_L2 : ''}
                            ${config.inverter.three_phase && config.entities?.inverter_current_L3 ? '| ' + data.inverter_current_L3 : ''}
                            A
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.battery_voltage_183)}>
                        <text id="battery_voltage_183" x="193" y="346"
                              ...
                              || !config.entities.battery_voltage_183 || !config.show_battery || data.compact ? 'none' : ''}"
                    ...
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.battery_voltage_183)}>
                        <text id="battery_voltage_183" x="281" y="299"
                              display="${config.entities.battery_voltage_183 === 'none'
                              || !config.entities.battery_voltage_183 || !config.show_battery || !data.compact ? 'none' : ''}"
                              fill=${data.bat_colour} class="${data.compact ? 'st3 left-align' : 'st12'}">
                            ${data.battery_voltage} V
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.battery_soc_184)}>
                        <text id="battery_soc_184" x="${data.compact ? '270' : '290'}" y="358"
                              display="${config.entities.battery_soc_184 === 'none' || !config.show_battery ? 'none' : ''}"
                              fill=${data.bat_colour} class="st13 st8 left-align">
                            ${parseInt(data.state_battery_soc.data.state)} %
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.battery_soc_184)}>
                        <text id="battery_soc_184" x="${data.compact ? '335' : '355'}" y="358" fill=${data.bat_colour}
                    ...
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.battery_power_190)}>
                        <text id="data.battery_power_190" x="${data.compact ? '239' : '193'}"
                              y="${data.compact ? '307' : '386'}"
                    ...
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.battery_current_191)}>
                        <text id="battery_current_191" x="193" y="365.3"
                              display="${!config.entities.battery_current_191 || config.entities.battery_current_191 === 'none' || !config.show_battery || data.compact ? 'none' : ''}"
                              fill=${data.bat_colour} class="${data.font !== true ? 'st14' : 'st4'} st8">
                            ${config.battery.show_absolute ? Math.abs(Utils.toNum(data.state_battery_current.data.state, 1)) : Utils.toNum(data.state_battery_current.data.state, 1)}
                            A
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.battery_current_191)}>
                    ...
                    ${config.inverter.three_phase
                            ? config.entities?.grid_ct_power_total
                                    ? svg`
                                        ...
                                        <text id="data.total_grid_power" x="135" y="219.2"
                    ...
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv1_voltage_109)}>
                        <text id="pv1_voltage" x="${config.solar.mppts === 1 ? '244.7' : '194'}" y="106"
                              ...
                              fill="${data.solar_colour}">${Utils.toNum(data.state_pv1_voltage.data.state, 1)} V
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv1_current_110)}>
                        <text id="pv1_current" x="${config.solar.mppts === 1 ? '244.7' : '194'}" y="94"
                              ...
                              fill="${data.solar_colour}">${Utils.toNum(data.state_pv1_current.data.state, 1)} A
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv2_voltage_111)}>
                        <text id="data.pv2_voltage" x="296" y="106" class="st3 left-align"
                              ...
                              fill="${data.solar_colour}">${Utils.toNum(data.state_pv2_voltage.data.state, 1)} V
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv2_current_112)}>
                        <text id="data.pv2_current" x="296" y="94" class="st3 left-align"
                              ...
                              fill="${data.solar_colour}">${Utils.toNum(data.state_pv2_current.data.state, 1)} A
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv3_voltage_113)}>
                        <text id="pv3_voltage" x="120" y="106" class="st3 left-align"
                              ...
                              fill="${data.solar_colour}">${Utils.toNum(data.state_pv3_voltage.data.state, 1)} V
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv3_current_114)}>
                        <text id="pv3_current" x="120" y="94" class="st3 left-align"
                              ...
                              fill="${data.solar_colour}">${Utils.toNum(data.state_pv3_current.data.state, 1)} A
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv4_voltage_115)}>
                        <text id="pv4_voltage" x="372" y="106" class="st3 left-align"
                              ...
                              fill="${data.solar_colour}">${Utils.toNum(data.state_pv4_voltage.data.state, 1)} V
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv4_current_116)}>
                        <text id="pv4_current" x="372" y="94" class="st3 left-align"
                              ...
                              fill="${data.solar_colour}">${Utils.toNum(data.state_pv4_current.data.state, 1)} A
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.battery_temp_182)}>
                        <text id="battery_temp_182" x="${data.compact ? '205' : '250'}"
                              y="${data.compact ? '332' : '324.5'}"
                              class="${config.entities?.battery_temp_182 ? 'st3 left-align' : 'st12'}"
                              fill="${data.bat_colour}" display="${!config.show_battery ? 'none' : ''}">
                            ${Utils.toNum(data.state_battery_temp.data.state, 1)}°
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.radiator_temp_91)}>
                        <text id="ac_temp" x="173" y="168.2" class="st3 left-align" fill="${data.inverter_colour}"
                              display="${config.entities?.radiator_temp_91 ? '' : 'none'}">AC:
                            ${Utils.toNum(data.state_radiator_temp.data.state, 1)}°
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.dc_transformer_temp_90)}>
                        <text id="dc_temp" x="173" y="180.4" class="st3 left-align" fill="${data.inverter_colour}"
                              display="${config.entities?.dc_transformer_temp_90 ? '' : 'none'}">DC:
                            ${Utils.toNum(data.state_dc_transformer_temp.data.state, 1)}°
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.environment_temp)}>
                        <text id="environ_temp" x="154" y="45"
                            ...
                            ${Utils.toNum(data.state_environment_temp.data.state, 1)}°
                        </text>
                    </a>
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.essential_load1_extra)}>
                        <text id="ess_load1_extra" x="465" y="157"
                              display="${config.entities?.essential_load1_extra && [1, 2].includes(data.additional_load) ? '' : 'none'}"
                              class="st3 .right-align" fill="${data.load_colour}">
                            ${Utils.toNum(data.state_essential_load1_extra.data.state, 1)}
                    ...
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.essential_load2_extra)}>
                        <text id="ess_load2_extra" x="465" y="282"
                              display="${config.entities?.essential_load2_extra && data.additional_load === 2 ? '' : 'none'}"
                              class="st3 .right-align" fill="${data.load_colour}">
                            ${Utils.toNum(data.state_essential_load2_extra.data.state, 1)}
                            ...
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.energy_cost_buy)}>
                                        <text id="energy_cost" x="105" y="195" class="${!config.show_grid ? 'st12' : 'st3 left-align'}" 
                                            ...
                                            ${data.energy_cost} ${data.state_energy_cost_buy.attributes?.unit_of_measurement}
                                        </text>
                                    </a>`
                            : svg`
                    ...
                    ${config.entities?.pv_total
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv_total)}>
                                        <text id="pvtotal_power" x="238.8" y="133.9" class="${data.font !== true ? 'st14' : 'st4'} st8" 
                                              display="${!config.show_solar || config.solar.mppts === 1 ? 'none' : ''}" 
                                              fill="${data.solar_colour}">
                                            ${config.solar.auto_scale
                                    ? config.entities?.pv_total
                    ...
                    ${config.entities?.pv1_power_186
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv1_power_186)}>
                                        <text id="pv1_power_186" x="${config.solar.mppts === 1 ? '238.8' : '188.1'}" y="71" class="${data.font !== true ? 'st14' : 'st4'} st8" 
                                              display="${!config.show_solar ? 'none' : ''}" 
                                              fill="${data.solar_colour}">
                                            ${config.solar.auto_scale
                                    ? Utils.convertValueNew(data.state_pv1_power.data.state, data.state_pv1_power.attributes?.unit_of_measurement, data.round)
                                    : `${Utils.toNum(data.state_pv1_power.data.state, 0)} W`
                            }
                                        </text>
                                    </a>`
                            : svg`
                    ...
                    ${config.entities?.pv2_power_187
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv2_power_187)}>
                                        <text id="pv2_power_187" x="289.5" y="71" class="${data.font !== true ? 'st14' : 'st4'} st8" 
                                              display="${!config.show_solar || config.solar.mppts === 1 ? 'none' : ''}" 
                                              fill="${data.solar_colour}">
                                            ${config.solar.auto_scale
                                    ? Utils.convertValueNew(data.state_pv2_power.data.state, data.state_pv2_power.attributes?.unit_of_measurement, data.round)
                                    : `${Utils.toNum(data.state_pv2_power.data.state, 0)} W`
                            }
                                        </text>
                                    </a>`
                            : svg`
                    ...
                    ${config.entities?.pv3_power_188
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv3_power_188)}>
                                        <text id="pv3_power_188" x="113" y="71" class="${data.font !== true ? 'st14' : 'st4'} st8" 
                                              display="${!config.show_solar || [1, 2].includes(config.solar.mppts) ? 'none' : ''}" 
                                              fill="${data.solar_colour}">
                                            ${config.solar.auto_scale
                                    ? Utils.convertValueNew(data.state_pv3_power.data.state, data.state_pv3_power.attributes?.unit_of_measurement, data.round)
                                    : `${Utils.toNum(data.state_pv3_power.data.state, 0)} W`
                            }
                                        </text>
                                    </a>`
                            : svg`
                    ...
                    ${config.entities?.pv4_power_189
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.pv4_power_189)}>
                                        <text id="pv4_power_189" x="366" y="71" class="${data.font !== true ? 'st14' : 'st4'} st8" 
                                              display="${!config.show_solar || [1, 2, 3].includes(config.solar.mppts) ? 'none' : ''}" 
                                              fill="${data.solar_colour}">
                                            ${config.solar.auto_scale
                                    ? Utils.convertValueNew(data.state_pv4_power.data.state, data.state_pv4_power.attributes?.unit_of_measurement, data.round)
                                    : `${Utils.toNum(data.state_pv4_power.data.state, 0)} W`
                            }
                                        </text>
                                    </a>`
                            : svg`
                    ...
                    ${config.entities?.essential_power && config.entities.essential_power !== 'none'
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.essential_power)}>
                                        <text id="ess_power" x="340.1" y="219.2" class="${data.font !== true ? 'st14' : 'st4'} st8" 
                                              fill="${data.load_colour}">
                    ...
                    ${config.entities?.essential_load1
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.essential_load1)}>
                                        <text id="ess_load1" x="440" y="133" display="${[1, 2].includes(data.additional_load) ? '' : 'none'}" 
                                              class="${data.font !== true ? 'st14' : 'st4'} st8" 
                                              fill="${data.load_colour}">
                                            ${config.load.auto_scale
                                    ? Utils.convertValueNew(data.state_essential_load1.data.state, data.state_essential_load1.attributes?.unit_of_measurement, data.round)
                                    : `${Utils.toNum(data.state_essential_load1.data.state, 0) || 0} ${
                            ...
                            : svg`
                                    <text id="ess_load1" x="440" y="133" display="${[1, 2].includes(data.additional_load) ? '' : 'none'}" 
                                          class="${data.font !== true ? 'st14' : 'st4'} st8" fill="${data.load_colour}">
                                        ${config.load.auto_scale
                                    ? Utils.convertValueNew(data.state_essential_load1.data.state, data.state_essential_load1.attributes?.unit_of_measurement, data.round)
                                    : `${Utils.toNum(data.state_essential_load1.data.state, 0) || 0} ${
                                            data.state_essential_load1.attributes?.unit_of_measurement !== undefined
                    ...
                    ${config.entities?.essential_load2
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.essential_load2)}>
                                        <text id="ess_load2" x="440" y="306.5" display="${data.additional_load === 2 ? '' : 'none'}" 
                                              class="${data.font !== true ? 'st14' : 'st4'} st8" 
                                              fill="${data.load_colour}">
                                            ${config.load.auto_scale
                                    ? Utils.convertValueNew(data.state_essential_load2.data.state, data.state_essential_load2.attributes?.unit_of_measurement, data.round)
                                    : `${Utils.toNum(data.state_essential_load2.data.state, 0) || 0} ${
                    ...
                    ${config.entities?.essential_load1
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.essential_load1)}>
                                        <text id="ess_load4" x="423" y="138" display="${data.additional_load === 4 ? '' : 'none'}" 
                                              class="st3" 
                                              fill="${data.load_colour}">
                                            ${config.load.auto_scale
                                    ? Utils.convertValueNew(data.state_essential_load1.data.state, data.state_essential_load1.attributes?.unit_of_measurement, data.round)
                    ...
                    ${config.entities?.essential_load2
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.essential_load2)}>
                                        <text id="ess_load4" x="459" y="138" display="${data.additional_load === 4 ? '' : 'none'}" 
                                              class="st3" 
                                              fill="${data.load_colour}">
                                            ${config.load.auto_scale
                                    ? Utils.convertValueNew(data.state_essential_load2.data.state, data.state_essential_load2.attributes?.unit_of_measurement, data.round)
                    ...
                    ${config.entities?.essential_load3
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.essential_load3)}>
                                        <text id="ess_load4" x="423" y="301" display="${data.additional_load === 4 ? '' : 'none'}" 
                                              class="st3" 
                                              fill="${data.load_colour}">
                                            ${config.load.auto_scale
                                    ? Utils.convertValueNew(data.state_essential_load3.data.state, data.state_essential_load3.attributes?.unit_of_measurement, data.round)
                                    : `${Utils.toNum(data.state_essential_load3.data.state, 0) || 0} ${
                            ...
                            : svg`
                                    <text id="ess_load4" x="423" y="301" display="${data.additional_load === 4 ? '' : 'none'}" class="st3" 
                                          fill="${data.load_colour}">
                                        ${config.load.auto_scale
                                    ? Utils.convertValueNew(data.state_essential_load4.data.state, data.state_essential_load4.attributes?.unit_of_measurement, data.round)
                                    : `${Utils.toNum(data.state_essential_load3.data.state, 0) || 0} ${
                                            data.state_essential_load3.attributes?.unit_of_measurement !== undefined
                                                    ? data.state_essential_load3.attributes?.unit_of_measurement
                                                    : ''
                    ...
                    ${config.entities?.essential_load4
                            ? svg`
                                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.essential_load4)}>
                                        <text id="ess_load4" x="459" y="301" display="${data.additional_load === 4 ? '' : 'none'}" 
                                              class="st3" 
                                              fill="${data.load_colour}">
                                            ${config.load.auto_scale
                                    ? Utils.convertValueNew(data.state_essential_load4.data.state, data.state_essential_load4.attributes?.unit_of_measurement, data.round)
                                    : `${Utils.toNum(data.state_essential_load4.data.state, 0) || 0} ${
                    ...
                    <a href="#" @click=${(e) => Utils.handlePopup(e, config.entities.prepaid_units)}>
                        <text id="prepaid" x="31.5" y="253"
                            ...
                            ${Utils.toNum(data.state_prepaid_units.data.state, 1)}
                        </text>
                    </a>
                </svg>
            </div>
